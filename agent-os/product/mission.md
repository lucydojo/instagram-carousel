...
- **Optimization Options + Presets:** Guide generation with tone/mood, target audience, and reusable user-saveable presets for consistent output
- **Global + Per-Slide Editing:** Apply changes to all slides (color palette) or customize individual slides with specific edits
